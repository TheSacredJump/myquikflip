...
export const GoogleGeminiEffect = ({
  ...
  const titleWords = (title || "Build with Aceternity UI").split(" ");
  ...
  return (
    <div className={cn("sticky top-52", className)}>
      ...
      >
        <p className="text-4xl md:text-7xl max-w-6xl mx-auto font-semibold pb-4 text-center mb-5 text-white tracking-wide">
      ...
      <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center bg-red-transparent absolute ">
        <motion.button
          className="font-bold bg-gradient-to-br from-gray-950 from-30% via-blue-900 via-55% to-gray-950 to-80% rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-white text-xs w-fit mx-auto hover:scale-105 duration-300"
